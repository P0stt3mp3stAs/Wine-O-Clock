...
export default function Navbar() {
  ...
  return (
    <nav className="text-white fixed w-full z-10 top-0 flex justify-between items-center px-4 py-1.5">
      ...
      <div className="bg-[#767676] rounded-full h-12 w-12 flex items-center justify-center">
        <img src={icons.profile} alt="Profile icon" className="h-12 w-12 cursor-pointer" />
      </div>
    </nav>
  );
}