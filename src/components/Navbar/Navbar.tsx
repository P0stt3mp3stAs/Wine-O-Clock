    ...
    <header>
      <nav className="text-white fixed w-full z-10 top-0 flex justify-between items-center px-4 py-1.5">
        ...
        {/* {
          isLoaded && user &&  */}
        <Link href="/dashboard">
          {/* <div className={`bg-[#767676] rounded-full h-12 w-12 flex items-center justify-center cursor-pointer ${currentPath === '/dashboard' ? 'bg-brown' : ''}`} style={{ backgroundColor: currentPath === '/dashboard' ? '#5E3200' : '#767676' }}>
